...
export class BartenderPage implements OnInit {
  ...
  constructor(private pedidoService: PedidoService, private toast: ToastService,
      ...
      if(this.idActivo == ''){
        ...
        this.pedidoService.obtenerPedido(pedido.idBD).subscribe( (ped:Pedido)=>{
          ...
          ped.productos.forEach( (prod:Producto)=>{
            if(prod.tipo == tipoProducto.bebida && prod.estado != estadoProducto.listo){
    ...
    prepararBebida(producto:Producto, pedido:Pedido){
    ...
    bebidaLista(producto:Producto, pedido:Pedido){
      this.cambiarEnBD(producto, pedido).subscribe( res =>{
        this.productos = [];
        this.pedidoService.obtenerPedido(pedido.idBD).subscribe( (ped:Pedido)=>{
